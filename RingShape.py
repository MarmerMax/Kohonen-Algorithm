...
X = Utils.createRandomPointsInRingArray(4, 2, centerX, centerY)
...
c1 = plt.Circle((centerX, centerY), 4, color='blue', fill=False)
c2 = plt.Circle((centerX, centerY), 2, color='blue', fill=False)
ax.add_artist(c1)
ax.add_artist(c2)
plt.show()
